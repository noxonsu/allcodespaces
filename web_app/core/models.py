...
class Channel(BaseModel):
    ...
    country = models.CharField(max_length=10, verbose_name=_('Страна'), null=True, blank=True)
    category = models.CharField(max_length=10, verbose_name=_('Тематика'), null=True, blank=True)
    # avg_post_coverage = models.PositiveIntegerField(verbose_name=_('Ср.рек.охват 1 поста'), default=0)
    ...
    members_count = models.PositiveIntegerField(verbose_name=_('Число подписчиков'), default=0)
    ...
    avg_posts_reach = models.PositiveIntegerField(blank=True, verbose_name=_('Охват'), default=0)
    er = models.PositiveIntegerField(blank=True, verbose_name=_('ER'), default=0)
    err = models.PositiveIntegerField(blank=True, verbose_name=_('ERR'), default=0)
    err_24 = models.PositiveIntegerField(blank=True, verbose_name=_('ERR24'), default=0)
    posts_count = models.PositiveIntegerField(blank=True, verbose_name=_('количество сообщений'), default=0)
    daily_reach = models.PositiveIntegerField(blank=True, verbose_name=_('ежедневный охват'), default=0)
    about = models.TextField(blank=True, verbose_name=_('описание'), default="")
    language = models.CharField(blank=True, verbose_name=_('Язык'), default="")
