...
class Channel(BaseModel):
    ...
    avg_posts_reach = models.FloatField(blank=True, verbose_name=_('Охват'), default=0)
    er = models.FloatField(blank=True, verbose_name=_('ER'), default=0)
    err = models.FloatField(blank=True, verbose_name=_('ERR'), default=0)
    err_24 = models.FloatField(blank=True, verbose_name=_('ERR24'), default=0)
    posts_count = models.PositiveIntegerField(blank=True, verbose_name=_('количество сообщений'), default=0)
    daily_reach = models.FloatField(blank=True, verbose_name=_('ежедневный охват'), default=0)
